#!/usr/bin/perl
# $Id: mrlg.cgi,v 1.1 2005/04/22 21:14:58 doros Exp $
...
$url="http://192.168.77.2/cgi-bin/mrlg.cgi";
...
print '
<OPTION Value="Cisco2503a">Cisco2503a
<OPTION Value="Cisco2503b">Cisco2503b
<OPTION Value="Cisco2503c">Cisco2503c
<OPTION Value="Cisco1600">Cisco1600
<OPTION Value="AN1">AN1
<OPTION Value="AN2">AN2
</select>
<br><br>
<B>Query</B>:
<br>
...
elsif ($Form{'router'} eq 'Cisco2503b')
        {
$server = 'Cisco2503b';
$login_pass = 'zebra';
$zebra = "zebra";
...
elsif ($Form{'router'} eq 'Cisco2503c')
        {
$server = 'Cisco2503c';
$login_pass = 'zebra';
$zebra = "zebra";
...
elsif ($Form{'router'} eq 'Cisco1600')
        {
$server = 'Cisco1600';
$login_pass = 'zebra';
$zebra = "zebra";
